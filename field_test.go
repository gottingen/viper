...
func (n username) MarshalLogObject(enc vipercore.ObjectEncoder) error {
...
func assertCanBeReused(t testing.TB, field Field) {
	...
	for i := 0; i < 100; i++ {
		enc := vipercore.NewMapObjectEncoder()
...
func TestFieldConstructors(t *testing.T) {
	...
	tests := []struct {
		...
		{"Skip", Field{Type: vipercore.SkipType}, Skip()},
		{"Binary", Field{Key: "k", Type: vipercore.BinaryType, Interface: []byte("ab12")}, Binary("k", []byte("ab12"))},
		{"Bool", Field{Key: "k", Type: vipercore.BoolType, Integer: 1}, Bool("k", true)},
		{"Bool", Field{Key: "k", Type: vipercore.BoolType, Integer: 1}, Bool("k", true)},
		{"ByteString", Field{Key: "k", Type: vipercore.ByteStringType, Interface: []byte("ab12")}, ByteString("k", []byte("ab12"))},
		{"Complex128", Field{Key: "k", Type: vipercore.Complex128Type, Interface: 1 + 2i}, Complex128("k", 1+2i)},
		{"Complex64", Field{Key: "k", Type: vipercore.Complex64Type, Interface: complex64(1 + 2i)}, Complex64("k", 1+2i)},
		{"Duration", Field{Key: "k", Type: vipercore.DurationType, Integer: 1}, Duration("k", 1)},
		{"Int", Field{Key: "k", Type: vipercore.Int64Type, Integer: 1}, Int("k", 1)},
		{"Int64", Field{Key: "k", Type: vipercore.Int64Type, Integer: 1}, Int64("k", 1)},
		{"Int32", Field{Key: "k", Type: vipercore.Int32Type, Integer: 1}, Int32("k", 1)},
		{"Int16", Field{Key: "k", Type: vipercore.Int16Type, Integer: 1}, Int16("k", 1)},
		{"Int8", Field{Key: "k", Type: vipercore.Int8Type, Integer: 1}, Int8("k", 1)},
		{"String", Field{Key: "k", Type: vipercore.StringType, String: "foo"}, String("k", "foo")},
		{"Time", Field{Key: "k", Type: vipercore.TimeType, Integer: 0, Interface: time.UTC}, Time("k", time.Unix(0, 0).In(time.UTC))},
		{"Time", Field{Key: "k", Type: vipercore.TimeType, Integer: 1000, Interface: time.UTC}, Time("k", time.Unix(0, 1000).In(time.UTC))},
		{"Uint", Field{Key: "k", Type: vipercore.Uint64Type, Integer: 1}, Uint("k", 1)},
		{"Uint64", Field{Key: "k", Type: vipercore.Uint64Type, Integer: 1}, Uint64("k", 1)},
		{"Uint32", Field{Key: "k", Type: vipercore.Uint32Type, Integer: 1}, Uint32("k", 1)},
		{"Uint16", Field{Key: "k", Type: vipercore.Uint16Type, Integer: 1}, Uint16("k", 1)},
		{"Uint8", Field{Key: "k", Type: vipercore.Uint8Type, Integer: 1}, Uint8("k", 1)},
		{"Uintptr", Field{Key: "k", Type: vipercore.UintptrType, Integer: 10}, Uintptr("k", 0xa)},
		{"Reflect", Field{Key: "k", Type: vipercore.ReflectType, Interface: ints}, Reflect("k", ints)},
		{"Reflect", Field{Key: "k", Type: vipercore.ReflectType}, Reflect("k", nil)},
		{"Stringer", Field{Key: "k", Type: vipercore.StringerType, Interface: addr}, Stringer("k", addr)},
		{"Object", Field{Key: "k", Type: vipercore.ObjectMarshalerType, Interface: name}, Object("k", name)},
		...
		{"Namespace", Namespace("k"), Field{Key: "k", Type: vipercore.NamespaceType}},
	}
...
func TestStackField(t *testing.T) {
	...
	assert.Equal(t, vipercore.StringType, f.Type, "Unexpected field type.")
