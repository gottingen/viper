...
func TestJSONClone(t *testing.T) {
	...
	parent := &jsonEncoder{buf: buffer.Get()}
	clone := parent.Clone()
...
func TestJSONEscaping(t *testing.T) {
	enc := &jsonEncoder{buf: buffer.Get()}
...
func TestJSONEncoderArrays(t *testing.T) {
	tests := []struct {
		...
		{"bool", `[true,true]`, func(e ArrayEncoder) { e.WriteBool(true) }},
		{"byteString", `["k","k"]`, func(e ArrayEncoder) { e.WriteByteString([]byte("k")) }},
		{"byteString", `["k\\","k\\"]`, func(e ArrayEncoder) { e.WriteByteString([]byte(`k\`)) }},
		...
		{"float64", `[3.14,3.14]`, func(e ArrayEncoder) { e.WriteFloat64(3.14) }},
		{"float32", `[3.14,3.14]`, func(e ArrayEncoder) { e.WriteFloat32(3.14) }},
		{"int", `[42,42]`, func(e ArrayEncoder) { e.WriteInt(42) }},
		{"int64", `[42,42]`, func(e ArrayEncoder) { e.WriteInt64(42) }},
		{"int32", `[42,42]`, func(e ArrayEncoder) { e.WriteInt32(42) }},
		{"int16", `[42,42]`, func(e ArrayEncoder) { e.WriteInt16(42) }},
		{"int8", `[42,42]`, func(e ArrayEncoder) { e.WriteInt8(42) }},
		{"string", `["k","k"]`, func(e ArrayEncoder) { e.WriteString("k") }},
		{"string", `["k\\","k\\"]`, func(e ArrayEncoder) { e.WriteString(`k\`) }},
		{"times", `[1,1]`, func(e ArrayEncoder) { e.AppendTime(time.Unix(1, 0)) }},
		{"uint", `[42,42]`, func(e ArrayEncoder) { e.WriteUint(42) }},
		{"uint64", `[42,42]`, func(e ArrayEncoder) { e.WriteUint64(42) }},
		{"uint32", `[42,42]`, func(e ArrayEncoder) { e.WriteUint32(42) }},
		{"uint16", `[42,42]`, func(e ArrayEncoder) { e.WriteUint16(42) }},
		{"uint8", `[42,42]`, func(e ArrayEncoder) { e.WriteUint8(42) }},
		{"uintptr", `[42,42]`, func(e ArrayEncoder) { e.WriteUintptr(42) }},
		{
			desc:     "arrays (success)",
			expected: `[[true],[true]]`,
...
func assertOutput(t testing.TB, expected string, f func(Encoder)) {
	enc := &jsonEncoder{buf: buffer.Get(), EncoderConfig: &EncoderConfig{
...
func viperEncode(encode func(*jsonEncoder, string)) func(s string) []byte {
...
func roundTripsCorrectlyString(original string) bool {
	return roundTripsCorrectly(viperEncode((*jsonEncoder).safeAddString), original)
}

func roundTripsCorrectlyByteString(original string) bool {
	return roundTripsCorrectly(
		viperEncode(func(enc *jsonEncoder, s string) {
