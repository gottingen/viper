...
func (s *sliceArrayEncoder) WriteBool(v bool)              { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteByteString(v []byte)      { s.elems = append(s.elems, string(v)) }
func (s *sliceArrayEncoder) AppendComplex128(v complex128)  { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) AppendComplex64(v complex64)    { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) AppendDuration(v time.Duration) { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteFloat64(v float64)        { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteFloat32(v float32)        { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteInt(v int)                { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteInt64(v int64)            { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteInt32(v int32)            { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteInt16(v int16)            { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteInt8(v int8)              { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteString(v string)          { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) AppendTime(v time.Time)         { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteUint(v uint)              { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteUint64(v uint64)          { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteUint32(v uint32)          { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteUint16(v uint16)          { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteUint8(v uint8)            { s.elems = append(s.elems, v) }
func (s *sliceArrayEncoder) WriteUintptr(v uintptr)        { s.elems = append(s.elems, v) }
